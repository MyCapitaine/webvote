$(document).ready(function() {
	...
	var validate = $("#signupForm").validate({
		...
		messages : {
			email : {
				required : "Form.PleaseInputEmail",
				email : "Form.PleaseInputCorrectEmail"
			},
			password : {
				required : "Form.PleaseInputPassword",
				minlength : "Form.PasswordFormat",
				maxlength : "Form.PasswordFormatMax"
			}
		}
	});
