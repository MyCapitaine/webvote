 ...
 */
public class SendValidateEmailForResetBE implements SendEmail{

    private static String getContent(String to, String url){
        StringBuffer  content=new StringBuffer ("您好：");
        content.append(to+"!<br>");
        content.append("请点击下面的链接来修改您的绑定邮箱（如果链接不能点击，请复制粘贴到浏览器地址栏）<br>");
        content.append("http://localhost:8080/home/resetBindingEmailValidate?");
        content.append(url);
